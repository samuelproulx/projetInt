...
(cl:defmethod cl:initialize-instance :after ((m <triangle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'triangle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name integration-srv:<triangle-request> is deprecated: use integration-srv:triangle-request instead.")))

(cl:ensure-generic-function 'p1-val :lambda-list '(m))
(cl:defmethod p1-val ((m <triangle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader integration-srv:p1-val is deprecated.  Use integration-srv:p1 instead.")
  (p1 m))

(cl:ensure-generic-function 'p2-val :lambda-list '(m))
(cl:defmethod p2-val ((m <triangle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader integration-srv:p2-val is deprecated.  Use integration-srv:p2 instead.")
  (p2 m))

(cl:ensure-generic-function 'p3-val :lambda-list '(m))
(cl:defmethod p3-val ((m <triangle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader integration-srv:p3-val is deprecated.  Use integration-srv:p3 instead.")
  (p3 m))
...
(cl:defmethod cl:initialize-instance :after ((m <triangle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'triangle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name integration-srv:<triangle-response> is deprecated: use integration-srv:triangle-response instead.")))

(cl:ensure-generic-function 'aire-val :lambda-list '(m))
(cl:defmethod aire-val ((m <triangle-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader integration-srv:aire-val is deprecated.  Use integration-srv:aire instead.")
  (aire m))
